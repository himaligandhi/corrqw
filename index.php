...
Frank is an experienced Chief Financial Officer skilled in empowering organizations to define, implement and achieve their mission while unlocking enterprise value with flawless execution. He is a senior consultant with COR Solutions, the advisory division of COR.
    ...
    <div class="row">
        ...
        <div class="col-md-9">
            <div class="profile-content" style="margin-top: 80px;">
                ...
                <span> <h6>Senior Hospitality Consultant</h6></span>
                <!--<span><h6> Licensed Mortgage Agent </h6></span>
                <span><h6>(LIC. M18001101)</span> </h6>-->
                <br>
                    <p style="font-size: 1.2em; color:black;">
